 ...
 var fbgcolor = '<td class="spider_label"><label for="' + prefix + '_fbgcolor">Background Color: </label></td>' +
  ...
  var dimensions = '<td class="spider_label"><label>Dimensions: </label></td>' +
                   '<td>' +
                     ...
                     '<input class="button-secondary wdps_free_button" type="button" value="Edit Image" onclick="alert(\'This functionality is disabled in free version.\')" />' +
...
function wdps_add_slide(wdps_post_fildes_name_,post_id) {
  ...
  var uploader_href_for_add_layer = uploader_href_for_add_slide.replace('add_update_slide', 'add_layer'); 
   /*slide_upload_by = ' <input id="button_image_url' + slideID + '" class="button-primary" type="button" value="Add Image from Media Library" onclick="spider_media_uploader(\'' + slideID + '\', event); return false;" />';*/
    ...
    img_layer_upload_by = ' <input class="action_buttons add_image_layer ' + ("secondary wdps_free_button") + '  button-small" type="button" value="Add Image Layer" onclick="' + ("alert('This functionality is disabled in free version.')") + '; return false;" />'
      ...
      '<table class="ui-sortable' + slideID + '">' +
        ...
        '<tbody>' +
          ...
          '</tr><tr><td colspan="4">' +
            ...
            '</div><div class="layer_add_buttons_wrap"><input class="action_buttons add_social_layer button-small wdps_free_button" type="button" value="Add Social Buttons Layer" onclick="alert(\'This functionality is disabled in free version.\'); return false;">' +
	    '</div><div class="layer_add_buttons_wrap"><input class="action_buttons add_hotspot_layer button-small wdps_free_button" type="button" value="Add Hotspot Layer" onclick="alert(\'This functionality is disabled in free version.\'); return false;"></td>' +
          '</tr></tbody></table>' +
...
function wdps_change_taxonomies() {
    ...
    function (data) {
     ...
     // wdps_success(jQuery(".wrap").attr('id'),0);
  });
